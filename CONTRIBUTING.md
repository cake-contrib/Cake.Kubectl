# Contributing to Cake.Kubernetes

First and foremost, thank you! We appreciate that you want to contribute to Cake.Kubernetes,
...
**Showing support for Cake.Kubernetes**  
...
Don't have time to contribute? No worries, here are some other ways to show your support for Cake.Kubernetes:

- star the [project][]
- tweet your support for Cake.Kubernetes
...
- **version**: (required) please note the version of Cake.Kubernetes you are using
...
- **addins, etc**: (if applicable) please list any other addins you're using that may affect the Cake.Kubernetes addin

### Closing issues

The original poster or the maintainers of Cake.Kubernetes may close an issue at any time.
Typically, but not exclusively, issues are closed when:

- The issue is resolved, and will be released in the next version of Cake.Kubernetes
...
[project]: https://github.com/Roman Marusyk/Cake.Kubernetes
