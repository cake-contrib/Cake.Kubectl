...
{
    public class KubernetesCreateFixture : ToolFixture<KubernetesCreateSettings>, ICakeContext
    {
        ...
        public KubernetesCreateFixture() : base("kubectl")
        {
        ...
        {
            this.KubernetesCreate(Settings);
        }
    }
}
