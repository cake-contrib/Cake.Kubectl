...
namespace KubectlParser
{
    public class Program
    {
        ...
        {
            var parsedOptions = ParseOptionLinesForDescription(info.Options);
            return new Command(
                info.Verb,
                info.Short,
                info.Description,
                ...
                options: parsedOptions
                    .Select(o => GetOptionFromText(o.Command, o.Description)).ToImmutableArray()
            );
        }

        public static ImmutableArray<(string Command, ImmutableArray<string> Description)> ParseOptionLinesForDescription(string[] lines)
        {
            var builder = ImmutableArray.CreateBuilder<(string Command, ImmutableArray<string> Description)>();
            string? command = null;
            ...
            foreach (string line in lines)
            {
                ...
                else
                {
                    ...
                    {
                        builder.Add((command, description.ToImmutableArray()));
                        command = null;
                        description.Clear();
                    }
                    else
        ...
        public static Option GetOptionFromText(string commandLine, IList<string> descriptionLines)
        {
        ...
        public static (string Caption, string[] Lines)? GetGroup(ref int index, string[] lines)
        {
            ...
            string line;
            while ((line = lines[index]) == string.Empty 
